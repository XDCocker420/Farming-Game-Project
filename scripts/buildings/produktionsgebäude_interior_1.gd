	...
	if player:
		...
		if player_scene:
			...
			if spawn_point:
				...
				print("ProduktionsgebäudeInterior1: Positioned player at spawn point: ", spawn_point.global_position)
				...
				print("ProduktionsgebäudeInterior1: ERROR - SpawnPoint node not found!")
		else:
